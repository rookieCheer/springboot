...
//@MapperScan("priv.lyf.admindao.dao*")
//public class MybatisConfigMetaObjOptLockConfig {
//
//	@Bean
//	public DataSource druidDataSource() throws SQLException {
//		DruidDataSource datasource = new DruidDataSource();
//		datasource.setUrl("jdbc:mysql://127.0.0.1:3306/admin?useUnicode=true&characterEncoding=UTF8&useSSL=false&serverTimezone=Asia/Shanghai");
...
//		sqlSessionFactory.setTypeAliasesPackage("priv.lyf.admindao.entity");
